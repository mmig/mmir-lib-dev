 ...
 *
 * If there are existing entries for array-properties (e.g. @param), the copy mechanism will
 *  * add new entries at the beginning
 *  * insert "overwritten" entries at the corresponding position of the copied source doclet
 *
